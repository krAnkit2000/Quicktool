...
const ImgBgRemove = () => {
  ...
  return (
    <div className="converter-container" style={{ maxWidth: '600px', margin: 'auto' }}>
      ...
      <h2 className="converter-title" style={{textAlign:'center', marginBottom:'15px'}}>
      ...
      <div style={{ marginTop: '1px', textAlign: 'center' }}>
        <p style={{ fontWeight: '600', marginBottom: '10px', color:'#475569' }}>
      ...
      <div className="settings-bar" style={{ justifyContent: 'center', marginTop: '25px' }}>
        {removedBgUrl ? (
          <a
            href={removedBgUrl}
            download="mytools_removed_bg.png"
